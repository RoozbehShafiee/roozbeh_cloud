		...
		public function setSections() {
			...
			$this->sections[] = array(
				...
				'fields' => array(
						...
						'id'=>'logo2x',
						'type' => 'media', 
						'title' => __('Logo For Retina-Ready Devices', 'redux-framework-demo'),
						'compiler' => 'true',
						'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
						'desc' => __('Upload the double-size version of your logo for retina-ready devices .. this is an optional step you can skip it. <br /> <br /><b>Note: </b> You can change logo margin from <b>Theme Style Settings</b>', 'redux-framework-demo'),
						) ,
						array(
						'id'=>'favicon',
						'type' => 'media', 
			...
			$this->sections[] = array(
				...
				'fields' => array(
						...
						'type' => 'switch', 
						'title' => __('Hide Sidebar Button', 'redux-framework-demo'),
						'desc'=> __('You can hide sidebar toggle button , By default sidebar toggle button is visible .', 'redux-framework-demo'),
						'default' => 1,
						'on' => 'Enabled',
						'off' => 'Disabled'
						),
			...
			$this->sections[] = array(
				...
				'fields' => array(
						...
						array(
							'id'=> 'comments_system',
							'type' => 'select',
							'title' => __('Select Comments System', 'redux-framework-demo'), 
							'desc' => __('You can choose between Wordpress comments system , Facebook , And Disqus', 'redux-framework-demo'),
							'options' => array(	
						...
						'id'=>'disqus_shortname',
						'type' => 'text', 
						'title' => __('Disqus Shortname', 'redux-framework-demo'),
						'desc'=> __('Add your disqus shortname , For example <b>http://shortname.disqus.com</b>', 'redux-framework-demo'),
						'default' => ''
						...
						'desc'=> __('Add your facebook app ID here , To get you facebook App ID : <br> 1- Login in <a href="https://developers.facebook.com/">https://developers.facebook.com/</a> <br> 2- Click on "Apps" from the top menu  <br> 3- You can create a new application or select the current active application <br> 4- On the App page copy the "App ID" and paste it here .', 'redux-framework-demo'),
						'default' => ''
						...
						'type' => 'slider', 
						'title' => __('Facebook Comments Count', 'redux-framework-demo'),
						'desc'=> __('Edit facebook comments count , default is 5 ', 'redux-framework-demo'),
						'default' => '5' ,
						"min" 		=> "1",
						"step"		=> "1",
						"max" 		=> "1000"
						...
						array(
							...
							'type' => 'select',
							'title' => __('Facebook Comments Theme', 'redux-framework-demo'), 
							'desc' => __('You can choose between dark and light skins', 'redux-framework-demo'),
							'options' => array(	
										'dark' => 'dark' ,
										'light' => 'light'),
							'default' => 'light'
						...
						'desc'=> __('Enter you preffered date format here , <br /> <b>Examples : "d m ,Y" will print : "07 April ,2014"</b> , <br /> For more information about date format check this link <a href="http://codex.wordpress.org/Formatting_Date_and_Time">http://codex.wordpress.org/Formatting_Date_and_Time</a><br /><b>Default Format</b> : d m , Y', 'redux-framework-demo'),
						'default' => 'd m , Y'
			...
			$this->sections[] = array(
				...
				'fields' => array(
						...
						'desc'=> __('You can select a background type from these options : <br /> 1- Images Slider <br /> 2- Single Image <br /> 3- Solid Color <br> 4- Background Patterns', 'redux-framework-demo'),
						'default' => '3',
						'options' => array(
									'1' => 'Images Slider' ,
									'2' => 'Single Image',
						...
						'compiler' => 'true',
						'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
						'desc' => __('Upload your background slider images here , Please make sure the "Images Slider" option is selected in "Background Type" above  . ', 'redux-framework-demo'),
						),
						array(
						'id'=>'background_image',
						'type' => 'media', 
						...
						'compiler' => 'true',
						'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
						'desc' => __('Upload your own background image , Please make sure the "Single Image" option is selected in "Background Type"', 'redux-framework-demo'),
						) ,
						...
						'desc' => __('Pick a background color , Please make sure the "Solid Color" option is selected in "Background Type"', 'redux-framework-demo'),
						'default' => '#f2f2f2',
						'validate' => 'color',
						),
						array(
						...
						'desc'=> __('Select a background pattern , Please make sure the "Background Patterns" option is selected in "Background Type" ', 'redux-framework-demo'),
						'default' 		=> 0,
						...
						array(
						'id'=>'post_header_hover',
						'type' => 'color',
						'title' => __('Post Headers Hover Color', 'redux-framework-demo'), 
						'desc' => __('Pick a color for post header hover', 'redux-framework-demo'),
						'default' => '#f4793d',
						'validate' => 'color',
						),
			...
			$this->sections[] = array(
				...
				'fields' => array(
						...
						'id'=>'bg_slider_speed',
						'type' => 'slider', 
						'title' => __('Background Slider Animation Speed', 'redux-framework-demo'),
						'desc'=> __('Edit background slider animation speed , default is 5000 ', 'redux-framework-demo'),
						"default" 		=> "5000",
						"min" 		=> "1000",
						"step"		=> "500",
						"max" 		=> "500000",
