...
$headers_hover = $options['post_header_hover'];

?>

/* background image */
<?php if( (isset($background_image) && $background_image['url'] != '') && (isset($background_type) && $background_type == 2) ) : ?>
body {
...
/* backgorund patterns */
<?php if( (isset($background_type) && $background_type == 4) && ( $pattern != '' ) ) : ?>
body {
...
/* headers hover color */
<?php if(isset($headers_hover) && $headers_hover != '') : ?>
h1 a:hover , h2 a:hover , h3 a:hover , h4 a:hover , h5 a:hover , h6 a:hover {
  color: <?php echo $headers_hover; ?> !important;
}
<?php endif; ?>
