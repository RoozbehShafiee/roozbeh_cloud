            ...
            <div class="container">
                <div class="row">
                   ...
                   <div id="blog" class="blog-wrapper col-md-12  col-xs-12">
						...
						<!-- inner row [bootstrap] -->
                   		<div class="row blog-grid-wrapper blog-grid-alt">
							...
							<?php if(is_sticky()) : ?>
							<div <?php post_class('single-post single-post-grid col-md-4 col-xs-12 sticky'); ?>>
							<?php else : ?>
							<div <?php post_class('single-post single-post-grid col-md-4 col-xs-12'); ?>>
							<?php endif; ?>
		                            ...
		                            <div class="post-content">
		                                ...
		                                <div class="post-content-inner-wrapper">
		                                                ...
		                                                <div class="post-inner-content">
		                                                        ...
		                                                        <!-- post main content -->
		                                                        <div class="main-content grid-main-content">
