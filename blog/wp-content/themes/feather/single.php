                            ...
                            <?php endif; ?>
                                    ...
                                    <div class="post-content">
                                        ...
                                        <div class="post-content-inner-wrapper">
                                                ...
                                                if(isset($feather_theme_options['comments_system']) && $feather_theme_options['comments_system'] != '')
                                                {
                                                        switch($feather_theme_options['comments_system']){
                                                                ...
                                                                case 'disqus' :
                                                                        feather_disqus(get_the_ID()  , get_the_title());
                                                                break;

                                                                case 'facebook' :

                                                                        feather_facebook_comments(get_permalink());
                                                                break;
