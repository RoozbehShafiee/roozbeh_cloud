            ...
            <div class="container">
                <div class="row">
                   ...
                   <div id="blog" class="blog-wrapper col-md-8  col-xs-12">
						...
						<!-- inner row [bootstrap] -->
                   		<div class="row blog-grid-wrapper">
							...
							<?php if(is_sticky()) : ?>
							<div <?php post_class('single-post single-post-grid col-md-6 col-xs-12 sticky'); ?>>
							<?php else : ?>
							<div <?php post_class('single-post single-post-grid col-md-6 col-xs-12'); ?>>
							<?php endif; ?>
