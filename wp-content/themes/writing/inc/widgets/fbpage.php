...
class fbpage_widget extends WP_Widget {
    ...
    function __construct() {
		parent::__construct(
			...
			array(
            'classname' => 'asalah-fbpage-widget',
            'description' => '',
            'width' => 250,
            'height' => 350,
    ...
    function form($instance) {
        $defaults = array('title' => __('Facebook Page', 'asalah'), 'fburl' => '', 'hide_posts' => 'false', 'hide_cover' => 'false', 'small_header' => 'false', 'show_faces' => 'true');
        ...
        <p>
          <label for="<?php echo $this->get_field_id('hide_posts'); ?>"><?php _e('Hide Page Posts', 'asalah'); ?>: </label>
          ...
          else echo ""; ?>><?php _e('No', 'asalah'); ?></option>
              <option value="true" <?php if ($instance['hide_posts'] == 'true') echo "selected=\"selected\"";
          else echo ""; ?>><?php _e('Yes', 'asalah'); ?></option>
          </select>
        </p>
        <p>
          <label for="<?php echo $this->get_field_id('small_header'); ?>"><?php _e('Use Small Header', 'asalah'); ?>: </label>
        ...
        <p>
          <label for="<?php echo $this->get_field_id('hide_cover'); ?>"><?php _e('Hide Cover Photo', 'asalah'); ?>: </label>
        ...
        <p>
          <label for="<?php echo $this->get_field_id('show_faces'); ?>"><?php _e('Show Friend\'s Faces', 'asalah'); ?>: </label>
