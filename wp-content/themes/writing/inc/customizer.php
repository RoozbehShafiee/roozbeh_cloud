	  		...
	  		?>
	 			<div class="text_radio_button_control">
	 				...
	 				<?php if( !empty( $this->description ) ) { ?>
	 					<span class="customize-control-description"><?php echo htmlspecialchars_decode( $this->description ); ?></span>
	 				<?php } ?>
...
function asalah_customize_partial_topbar() {
	...
	if (	// sliding sidebar enabled
				...
				(
					(intval(asalah_cross_option('asalah_site_width')) < 701) &&
					(intval(asalah_cross_option('asalah_site_width')) > 499) &&
...
function asalah_register_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_section( 'asalah_layout_general' , array(
	    'title'      => __('General Settings','asalah'),
	    'priority'   => 20,
			'panel'			 => 'asalah_layout_panel',
	) );

	$wp_customize->add_section( 'asalah_layout_banner' , array(
	    'title'      => __('Banner/Featured Image Settings','asalah'),
	    'priority'   => 20,
			'panel'			 => 'asalah_layout_panel',
	) );

	$wp_customize->add_section( 'asalah_layout_meta_tags' , array(
	    'title'      => __('Meta Tags Settings','asalah'),
	    'priority'   => 20,
			'panel'			 => 'asalah_layout_panel',
	) );

	$wp_customize->add_section( 'asalah_layout_post_content' , array(
	    'title'      => __('Content Settings','asalah'),
	    'priority'   => 20,
			'panel'			 => 'asalah_layout_panel',
	) );

	$wp_customize->add_section( 'asalah_layout_control_post' , array(
	    'title'      => __('Share and Continue Reading Settings','asalah'),
	    'priority'   => 20,
			'panel'			 => 'asalah_layout_panel',
	) );

	$wp_customize->add_section( 'asalah_layout_single' , array(
	    'title'      => __('General Page/Post Settings','asalah'),
			'description' => __('These options affects all single posts/pages, to edit one single post, you will need to edit post options.', 'asalah'),
	    'priority'   => 20,
			'panel'			 => 'asalah_layout_panel',
	) );
	...
	$wp_customize->add_panel( 'asalah_header_panel' , array(
	    'title'      => __('Top Bar and Header Style','asalah'),
	    'priority'   => 30,
	) );

	$wp_customize->add_section( 'asalah_header_topbar' , array(
	    'title'      => __('Top Bar Style','asalah'),
	    'priority'   => 20,
	...
	$wp_customize->add_section( 'asalah_logo_general' , array(
	    'title'      => __('General Logo Settings','asalah'),
	    'priority'   => 20,
			'panel'			 => 'asalah_logo_panel'
	) );

	$wp_customize->add_section( 'asalah_logo_text' , array(
	    'title'      => __('Text Logo','asalah'),
			'description' => __('You can edit the <a data-control="blogname" href="#" class="asalah-custom-refresh-partial">Logo Text</a>.', 'asalah'),
	    'priority'   => 20,
			'panel'			 => 'asalah_logo_panel'
	) );

	$wp_customize->add_section( 'asalah_logo_image' , array(
	    'title'      => __('Image Logo','asalah'),
	    'priority'   => 20,
			'panel'			 => 'asalah_logo_panel'
	) );

	$wp_customize->add_section( 'asalah_logo_tagline' , array(
	    'title'      => __('Tagline Settings','asalah'),
			'description' => __('You can customize tagline text from <a data-control="blogdescription" href="#" class="asalah-custom-refresh-partial">Site Identity</a>.', 'asalah'),
	    'priority'   => 20,
			'panel'			 => 'asalah_logo_panel'
	) );
	/* End Logo Panel */
  ...
  $wp_customize->add_control('asalah_site_description', array(
      'label'      => __('Site Description', 'asalah'),
			'description'=> __('Few words about your blog to introducte it to search engines and social networks', 'asalah'),
      'section'    => 'asalah_social_general',
  ...
  $wp_customize->add_control('asalah_facebook_comments_num',
	...
	***/
	...
	$wp_customize->add_control( new asalah_Text_Radio_Button_Custom_Control( $wp_customize, 'asalah_logo_position', array(
				'label'      => __('Logo Position (Default is in header', 'asalah'),
				'description' => __('In case of top bar, text is only allowed.', 'asalah'),
				'section'    => 'asalah_logo_general',
				'settings'   => 'asalah_logo_position',
				'choices'    => array(
						'header' => __('Header (default)', 'asalah'),
						'top_bar' => __('Top Bar', 'asalah'),
				),
		)
	));
	...
	$wp_customize->add_control( new asalah_Text_Radio_Button_Custom_Control( $wp_customize, 'asalah_logo_type', array(
				'label'      => __('Logo Type (Default is Text or Image if available)', 'asalah'),
				'description' => __('You can customize <a data-control="asalah_logo_text" data-focus="section" href="#" class="asalah-custom-refresh-partial">Text Logo Settings</a>, or <a data-control="asalah_logo_image" data-focus="section" href="#" class="asalah-custom-refresh-partial">Image Logo Settings</a>.', 'asalah'),
				'section'    => 'asalah_logo_general',
				...
				'choices'    => array(
						...
						'image_text' => __('Image Logo & Site Name', 'asalah'),
				),
		)
	));
	...
	***/
	...
	$wp_customize->add_control(new asalah_Slider_Custom_Control( $wp_customize, $option,
		array(
			...
			'description' => __('Use <a target="_blank" href="https://wordpress.org/plugins/regenerate-thumbnails/">Regenerate Thumbnails</a> plugin after changing the options.', 'asalah'),
			'section' => $section,
			'settings' => $option,
			'input_attrs' => array(
				'min'   => $min,
  ...
  $wp_customize->add_control( new asalah_Text_Radio_Button_Custom_Control( $wp_customize, 'asalah_sidebar_position', array(
	...
	if (get_bloginfo('version') >= '4.3') {
		...
		$wp_customize->add_control( new WP_Customize_Cropped_Image_Control($wp_customize, 'asalah_header_avatar', array(
			'label'      => __('Sliding Sidebar Icon Avatar', 'asalah'),
			'section'    => 'asalah_layout_general',
  ...
  $wp_customize->add_control( new asalah_Toggle_Switch_Custom_control( $wp_customize, 'asalah_banners_devices_size', array(
	      'label'      => 'Enable different sizes for different screens',
				'description' => __('Recommended, Use <a target="_blank" href="https://wordpress.org/plugins/regenerate-thumbnails/">Regenerate Thumbnails</a> plugin after changing the options.', 'asalah'),
	      'section'    => 'asalah_layout_banner',
	  )
	));
  ...
  $wp_customize->add_control( new asalah_Text_Radio_Button_Custom_Control( $wp_customize, 'asalah_cat_desc', array(
	      'label'      => __('Show Category Description', 'asalah'),
	      'section'    => 'asalah_taxonomies_cat',
  ...
  $wp_customize->add_control( new asalah_Text_Radio_Button_Custom_Control( $wp_customize, 'asalah_tag_desc', array(
	      'label'      => __('Show Tag Description', 'asalah'),
	      'section'    => 'asalah_taxonomies_tag',
  ...
  $wp_customize->add_control('posts_per_page',
	...
	$wp_customize->get_control( 'blogname' )->description = __('You can customize Text Logo Style from <a data-control="asalah_logo_text" data-focus="section" href="#" class="asalah-custom-refresh-partial">Text Logo Settings</a>.', 'asalah');
	$wp_customize->get_setting( 'blogdescription' )->transport = 'postMessage';
	$wp_customize->get_control( 'blogdescription' )->description = __('You can customize tagline from <a data-control="asalah_show_tagline" href="#" class="asalah-custom-refresh-partial">Tagline Settings</a>.', 'asalah');
